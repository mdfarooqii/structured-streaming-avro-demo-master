...
public class StructuredDemo {
    ...
    public static void main(String[] args) throws StreamingQueryException {
        ...
        Dataset<Row> ds1 = sparkSession
                ...
                .option("subscribe", "stream-demo-position-json-topics")
        ...
        /*ds2.writeStream().format("parquet")
                .option("checkpointLocation", "C:\\farooq_learning\\sample_data\\stream\\parquet\\output")
                .option("path", "C:\\farooq_learning\\sample_data\\stream\\json\\output").outputMode("APPEND")
       ...
       .start();*/
        ...
        sparkSession.streams().get("Test query").awaitTermination();
